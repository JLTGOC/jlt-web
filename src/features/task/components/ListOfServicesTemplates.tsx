...
import { useTemplateList } from "../hooks/usePlanningTimeline";

import { PageCard } from "@/components/PageCard";
import { Add, Visibility} from "@nine-thirty-five/material-symbols-react/rounded";
    ...
    <>
      <PageCard
        ...
        action={
          <>
            <Button
              onClick={() => navigate("/tools/planning-timeline/add-template", {state: {serviceType: serviceType}})}
              leftSection={<Add />}
            >
              ADD TEMPLATE
            </Button>
