...
import { MAKE_QUOTATION_STEP_LABELS } from "../constants/make-quotation.constants";
...
import { isTermsComplete, resolveTemplateType } from "../utils/template";

export function MakeQuotationContent() {
