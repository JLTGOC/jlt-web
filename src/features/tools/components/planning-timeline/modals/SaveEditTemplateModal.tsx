  ...
  return (
    ...
    >
      <Box style={{ padding: "1rem 0.5rem 0.5rem", textAlign: "center" }}>
          <QuickReference style={{ width: 100, height: 100 }} color="#AA4851"></QuickReference>

        <Text fw={500} size="sm" style={{ marginBottom: 12, lineHeight: 1.4, letterSpacing: "0.02em" }}>
          ARE YOU SURE YOU WANT TO SAVE THESE TEMPLATE CHANGES?
        </Text>

        <Text c="dimmed" size="sm" style={{ marginBottom: 28, lineHeight: 1.6 }}>
          Updating this template will affect workflows and processes using this
          configuration. Please review all modifications carefully before proceeding.
        </Text>
